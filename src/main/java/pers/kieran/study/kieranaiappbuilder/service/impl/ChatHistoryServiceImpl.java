package pers.kieran.study.kieranaiappbuilder.service.impl;
...
import pers.kieran.study.kieranaiappbuilder.constant.UserConstant;
...
import pers.kieran.study.kieranaiappbuilder.model.dto.chathistory.ChatHistoryQueryRequest;
import pers.kieran.study.kieranaiappbuilder.model.entity.App;
import pers.kieran.study.kieranaiappbuilder.model.entity.ChatHistory;
import pers.kieran.study.kieranaiappbuilder.mapper.ChatHistoryMapper;
...
public class ChatHistoryServiceImpl extends ServiceImpl<ChatHistoryMapper, ChatHistory>  implements ChatHistoryService{
    ...
    public QueryWrapper getQueryWrapper(ChatHistoryQueryRequest chatHistoryQueryRequest) {
        ...
        // 拼接查询条件（判空，避免 MyBatis-Flex 将 null 生成为 IS NULL）
        if (id != null) {
